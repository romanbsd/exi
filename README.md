...
- XSD compilation for global elements, named/inline complex types, attributes,
  ...
  base-only simple types, typed lists, and String-represented unions, plus
  attributed `simpleContent` and `complexContent` extension, unconstrained
...
imports/includes, simple-type facets, complex-content
