...
- strict compiled schemas and schema-valid first-level paths plus early
  end-element and untyped-character deviations through non-strict schemas,
  containing global elements, attributes, sequences, choices, unordered `all`
  groups, and optional, bounded, or unbounded element and compositor particles,
  including mixed and nillable content and named derived-type selection through
...
untyped characters, and more general schema-informed grammars, relaxed
