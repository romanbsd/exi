...
final class _Compiler {
  ...
  _SimpleType? _builtinSimpleType(String qualifiedName) {
    ...
    final _SimpleType? simpleType = switch (localName) {
      ...
      'boolean' => _scalarType(ExiDatatype.boolean, whiteSpace: 'collapse'),
      'decimal' => _scalarType(ExiDatatype.decimal, whiteSpace: 'collapse'),
      'float' || 'double' => _scalarType(ExiDatatype.float, whiteSpace: 'collapse'),
      'integer' => _scalarType(ExiDatatype.integer, whiteSpace: 'collapse'),
      'long' => _scalarType(
        ExiDatatype.integer,
      ...
      'negativeInteger' => _scalarType(ExiDatatype.integer, integerMaxInclusive: -BigInt.one, whiteSpace: 'collapse'),
      'nonPositiveInteger' => _scalarType(
        ExiDatatype.integer,
        integerMaxInclusive: BigInt.zero,
        whiteSpace: 'collapse',
      ),
      'byte' => _scalarType(
        ExiDatatype.byte,
      ...
      'nonNegativeInteger' => _scalarType(
        ExiDatatype.unsignedInteger,
        integerMinInclusive: BigInt.zero,
        whiteSpace: 'collapse',
      ),
      'positiveInteger' => _scalarType(
        ExiDatatype.unsignedInteger,
        integerMinInclusive: BigInt.one,
        whiteSpace: 'collapse',
      ),
      ...
      'base64Binary' => _scalarType(ExiDatatype.base64Binary, whiteSpace: 'collapse'),
      'hexBinary' => _scalarType(ExiDatatype.hexBinary, whiteSpace: 'collapse'),
      'dateTime' => _scalarType(ExiDatatype.dateTime, whiteSpace: 'collapse'),
      'date' => _scalarType(ExiDatatype.date, whiteSpace: 'collapse'),
      'time' => _scalarType(ExiDatatype.time, whiteSpace: 'collapse'),
      'gYear' => _scalarType(ExiDatatype.gYear, whiteSpace: 'collapse'),
      'gYearMonth' => _scalarType(ExiDatatype.gYearMonth, whiteSpace: 'collapse'),
      'gMonth' => _scalarType(ExiDatatype.gMonth, whiteSpace: 'collapse'),
      'gMonthDay' => _scalarType(ExiDatatype.gMonthDay, whiteSpace: 'collapse'),
      'gDay' => _scalarType(ExiDatatype.gDay, whiteSpace: 'collapse'),
      'duration' => _scalarType(ExiDatatype.string, whiteSpace: 'collapse'),
      'QName' || 'NOTATION' => _scalarType(ExiDatatype.string, enumerationEligible: false, whiteSpace: 'collapse'),
      _ => null,
    };
